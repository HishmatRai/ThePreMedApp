...
export default function GameOver2(props) {
    return (
            ...
            <View style={styles._main}>
                ...
                <View style={styles._body_data}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <TouchableOpacity style={styles._try_btn} onPress={() => props.navigation.navigate("EndlessModePlay2")}>
                        ...
                        <TouchableOpacity style={styles.BacktoMenu_btn} onPress={() => props.navigation.navigate("TimedMode")}>
