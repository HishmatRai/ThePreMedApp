...
export default function EndlessModePlay2(props) {
                ...
                <View style={styles.centeredView}>
                    <BlurView >
                        <View style={styles.modalView}>
                            <TouchableOpacity onPress={() => props.navigation.navigate("GameOver2")} style={styles._close_btn}>
                            ...
                            <Text style={styles.modalText}>Unlock over 3000 questions, leaderboards, and more!</Text>
