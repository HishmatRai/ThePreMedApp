...
function InstitutionHighScoreTabs100() {
    return (
        <Box width="100%">
            <Tabs isFitted colorScheme="orange">
                <Tabs.Bar>
                    <Tabs.Tab style={{color:"white"}}>Rank</Tabs.Tab>
                    <Tabs.Tab>Score</Tabs.Tab>
                    <Tabs.Tab>Institution</Tabs.Tab>
                </Tabs.Bar>
                <Tabs.Views p={0} >
                    <Tabs.View width="100%" p={0}>
                        <View style={styles._Tab1_main}>
                            ...
                            <Text style={styles._total}>Your Institution: 300th</Text>
                        </View>
                    </Tabs.View>
